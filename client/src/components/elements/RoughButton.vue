...
button:hover {
  box-shadow: 1px 2px 1px var(--secondary-colour), 0 2px 0 2px var(--primary-colour);
  transform: none; //TODO: remove this later
}

button:active {
  top: 4px;
  padding-bottom: 0;
  box-shadow: 0 1px 0 var(--secondary-colour);;
}
...
button {
  ...
  border-bottom: none;
  box-shadow: 1px 2px 1px var(--secondary-colour);
